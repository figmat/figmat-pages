...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppLimitsLimitsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var LimitsComponent = /*#__PURE__*/function () {
      ...
      _createClass(LimitsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParams.subscribe(function (params) {
            if (params['code']) {
              _this.http.post('/api/figma-limits', {
                ...
                _this.symbolsLim = v.Symbols;
                _this.sentencesLim = v.Sentences;
                _this.figmatid = v.Figmatid;
              });
            }
          });
          var stripe = Stripe('pk_test_51GwZIhASKhSlqpJrkussYAZhiIgcprlaCm6prJHGJO9spkr4tkKFNZPRevwp2jHzeVBZ390rmfkwst6aZaUqKeJ500zF6BJfXb'); // console.log(JSON.stringify(stripe));
          ...
          card.mount('#card-element'); // registerElements([card], 'example1');
        }
      }, {
        key: "pay",
    ...
    LimitsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function LimitsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LimitsComponent_Template_mat_button_toggle_group_ngModelChange_19_listener($event) {
            return ctx.paymentValue = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](30, "Confirm payment - temporally disabled");
  ...
  function srcAppPaymentPaymentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PaymentComponent = /*#__PURE__*/function () {
      function PaymentComponent(fb) {
        _classCallCheck(this, PaymentComponent);

        this.fb = fb;
        this.elementsOptions = {// locale: 'de'
      ...
      _createClass(PaymentComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var stripe = Stripe('pk_test_51GwZIhASKhSlqpJrkussYAZhiIgcprlaCm6prJHGJO9spkr4tkKFNZPRevwp2jHzeVBZ390rmfkwst6aZaUqKeJ500zF6BJfXb');
        ...
        value: function buy() {
          ...
          fetch("/api/secret", {
            ...
            console.log(JSON.stringify(data)); // const stripe = Stripe("");
    ...
    PaymentComponent.ɵfac = function PaymentComponent_Factory(t) {
      return new (t || PaymentComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
    };
